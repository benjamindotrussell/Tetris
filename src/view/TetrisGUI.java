...
public class TetrisGUI implements Observer {
    ...
    /** level up delay. */
    private static final int LVL_DELAY = 100;
    /** initial board width. */
    ...
    private int myHigh;
    /** field to hold the current level. */
    private int myLevel;
    /** the panel that shows the current level. */
    private final LevelPanel myLevelPanel;
    /** 
     * class constructor.
     */
    public TetrisGUI() {
    ...
    private JPanel eastPanel() {
        ...
        myLevelPanel.setBackground(Color.ORANGE);
        myLevelPanel.setPreferredSize(LABEL_SIZE);
    ...
    private class TimerAction implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent theEvent) {
            ...
            if (myScore % 2000 == 0) {
                ...
                myTimer.setDelay(delay - LVL_DELAY);
                myLevel++;
            }
        }
    } 
    ...
    public class HighScorePanel extends JPanel implements Observer {
        ...
        public void paintComponent(final Graphics theGraphics) {
            ...
            final String high = Integer.toString(myHigh);
            g2d.drawString("High Score", INIT_WIDTH, getHeight() / 2);
            g2d.drawString(high, (getWidth() / 2) - INIT_HEIGHT, getHeight() / 2);
        }
    ...
    /** 
     * inner class for the level panel.
     * 
     * @author Ben Russell
     * @version 12/11/2015
     */
    ...
    public class LevelPanel extends JPanel implements Observer {
        ...
        public void paintComponent(final Graphics theGraphics) {
            ...
            final String level = Integer.toString(myLevel);
            g2d.drawString("Level", INIT_WIDTH, getHeight() / 2);
            g2d.drawString(level, (getWidth() / 2) - INIT_HEIGHT, getHeight() / 2);
        }
